export function HeroVisual() {
  return (
    ...
    >
      ...
      <div className="absolute left-[6%] top-[8%] w-[58%] rotate-[-6deg] rounded-2xl border border-border bg-surface/95 p-3 shadow-[0_18px_40px_rgba(0,0,0,0.35)] transition-transform duration-500 ease-out hover:-translate-y-1">
      ...
      <div className="absolute right-[4%] top-[18%] z-10 w-[54%] rotate-[5deg] rounded-2xl border border-border bg-surface/95 p-3 shadow-[0_20px_44px_rgba(0,0,0,0.4)] transition-transform duration-500 ease-out hover:-translate-y-1">
      ...
      <div className="absolute bottom-[6%] left-[18%] z-20 w-[62%] rounded-2xl border border-border bg-surface/95 p-3 shadow-[0_22px_48px_rgba(0,0,0,0.45)] transition-transform duration-500 ease-out hover:-translate-y-1">
        <div className="mb-3 flex items-center justify-between">
